 ...
 */
export interface GenericTransactionCode { 
    /**
     * Code type in PascalCase form. Possible values are: DetailBAI, SummaryBAI, TransactionCode. 
     */
    codeType: string;
    /**
     * Name of the code in PascalCase. Possible values: ResponseCode, PromotionCode, Domain, Family, Subfamily, MT940, SourceCode, TaxDeferredContributionCode. 
     */
    name?: string;
    /**
     * Code value.
